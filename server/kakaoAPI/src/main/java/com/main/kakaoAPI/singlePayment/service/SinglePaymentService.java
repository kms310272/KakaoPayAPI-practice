package com.main.kakaoAPI.singlePayment.service;
...
import com.main.kakaoAPI.singlePayment.mapper.SinglePaymentMapper;
import com.main.kakaoAPI.singlePayment.repository.SinglePaymentRepository;
...
//    private SinglePaymentMapper mapper;
    ...
    public ReadyResponseDto kakaoPayReady(PaymentRequestDto paymentRequestDto) {
        ...
        log.info("paymentRequestDto.getOrderId():"+paymentRequestDto.getOrderId());
        log.info("parameters.get(\"partner_order_id\")"+parameters.get("partner_order_id"));
